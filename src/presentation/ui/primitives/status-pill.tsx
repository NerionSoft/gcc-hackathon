...
import { SEVERITY_META, STATUS_LABEL, STATUS_TONE, type StatusTone } from "@/presentation/ui/severity";
...
const TONE_STYLE: Record<StatusTone, { color: string; bg: string; border: string }> = {
  ...
  green: { color: SEVERITY_META.green.color, bg: SEVERITY_META.green.tint, border: SEVERITY_META.green.edge },
  amber: { color: SEVERITY_META.amber.color, bg: SEVERITY_META.amber.tint, border: SEVERITY_META.amber.edge },
  red: { color: SEVERITY_META.red.color, bg: SEVERITY_META.red.tint, border: SEVERITY_META.red.edge },
};
